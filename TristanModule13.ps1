...
Version 4 - Test-CloudFlare 
Added try and catch actions for error handling.
Used custompsobject to simplify the conection process.
...
# Enabling cmdlet binding.
    ...
    Foreach ($Eachvalue in $Computername) {
        ...
        Catch {Write-Host "Remote connection to $Eachvalue failed." -ForegroundColor 'Red'}
